    ...
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
        <div className='shortcut-links'>
          ...
          <div className={`side-link ${category===28?"active":""}`} onClick={()=>setCategory(28)}>
            <img src={tech} alt="icon" /><p>Technology</p>
          </div>
        ...
        <div className="subscribed-list">
          ...
          <div className='side-link'>
             <img src={jack} alt="icon" /><p>PewDiePie</p>
          </div>
          <div className='side-link'>
             <img src={simon} alt="icon" /><p>MrBeast</p>
          </div>
          <div className='side-link'>
             <img src={tom} alt="icon" /><p>Justin Bieber</p>
          </div>
          <div className='side-link'>
             <img src={megan} alt="icon" /><p>5-Minutes Crafts</p>
          </div>
          <div className='side-link'>
             <img src={cameron} alt="icon" /><p>Nas Daily</p>
          </div>
        </div>
    </div>
  )
