    ...
    return (
        <div className='play-video'>
            ...
            <div className="play-video-info">
                ...
                <div>
                    <span><img src={like} alt="icon" /> {apiData ? valueConverter(apiData.statistics.likeCount) : 155}</span>
                    <span><img src={dislike} alt="icon" /> </span>
                    <span><img src={share} alt="icon" /> Share</span>
                    <span><img src={save} alt="icon" /> Save</span>
                </div>
            </div>
            <hr />
            <div className="publisher">
                <img src={channelData ? channelData.snippet.thumbnails.default.url : ""} alt="icon" />
                <div>
                ...
                {commentData.map((item, index) => {
                    return (
                        <div key={index} className="comment">
                            <img src={item.snippet.topLevelComment.snippet.authorProfileImageUrl} alt="icon" />
                            <div>
